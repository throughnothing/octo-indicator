...
from octoindicator_lib.PreferencesDialog import PreferencesDialog

class PreferencesOctoindicatorDialog(PreferencesDialog):
    __gtype_name__ = "PreferencesOctoindicatorDialog"

    def finish_initializing(self, builder): # pylint: disable=E1002
        """Set up the preferences dialog"""
        super(PreferencesOctoindicatorDialog, self).finish_initializing(builder)
