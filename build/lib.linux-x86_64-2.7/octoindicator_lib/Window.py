...
import gtk
import logging
logger = logging.getLogger('octoindicator_lib')

from . helpers import get_builder, show_uri, get_help_uri
from . preferences import preferences

# This class is meant to be subclassed by OctoindicatorWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseOctoindicatorWindow object.
        """
        builder = get_builder('OctoindicatorWindow')
        new_object = builder.get_object("octoindicator_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a OctoindicatorWindow object with it in order to finish
        initializing the start of the new OctoindicatorWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('octoindicator')
        except ImportError:
            pass
        ...
        try:
            from octoindicator import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for octoindicator."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for octoindicator."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the OctoindicatorWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the OctoindicatorWindow is closed."""
